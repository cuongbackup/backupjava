                ...
                <div class="main-content">
                    ...
                    <div class="content-left">
                        <div class="img-border">
                            <img
                                src="image/19657434_1899909526926678_1129520503603659229_n.jpg"
                                alt=""/>
                        ...
                        <c:if test="${empty noContent}">
                            <c:forEach var="i" items="${content}">
                                <div class="border-post">
                                    <span><a
                                            href="DetailsController?id=${i.getId()}">${i.getTitle()}</a></span>
                                    <div class="post">
                                        <div class="left-post">
                                            <a href="DetailsController?id=${i.getId()}"><img
                                                    src="${i.getImgLink()}" alt=""></a>
                                        </div>
